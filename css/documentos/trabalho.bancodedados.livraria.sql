...
-- 2. Consulta para listar o quantitativo de livros cadastrados     

SELECT COUNT(*) AS QuantidadeLivros FROM Livro;

-- 3. Consulta para listar o nome dos clientes cadastrados em ordem crescente

SELECT nome FROM Cliente ORDER BY nome ASC;

-- 4. Consulta para listar o nome de todas as editoras e os títulos de seus respectivos livros, em ordem decrescente pelo nome das editoras
...
-- 5. Consulta para listar o nome das editoras e a média de preço de seus respectivos livros (group by)
...
-- 6. Consulta para listar o nome de todos os clientes e a quantidade de livros comprados pelos mesmos (group by)

SELECT Cliente.nome AS NomeCliente, SUM(ItemPedido.quantidade) AS QuantidadeLivrosComprados
FROM Cliente
